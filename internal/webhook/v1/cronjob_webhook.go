...
func SetupCronJobWebhookWithManager(mgr ctrl.Manager) error {
	return ctrl.NewWebhookManagedBy(mgr).For(&webappv1.CronJob{}).
		WithValidator(&CronJobCustomValidator{}).
		WithDefaulter(&CronJobCustomDefaulter{
			DefaultConcurrencyPolicy:          webappv1.AllowConcurrent,
...
// +kubebuilder:webhook:path=/mutate-webapp-xilia-net-v1-cronjob,mutating=true,failurePolicy=fail,sideEffects=None,groups=webapp.xilia.net,resources=cronjobs,verbs=create;update,versions=v1,name=mcronjob-v1.kb.io,admissionReviewVersions=v1
...
type CronJobCustomDefaulter struct {
	...
	DefaultConcurrencyPolicy          webappv1.ConcurrencyPolicy
	DefaultSuspend                    bool
...
func (d *CronJobCustomDefaulter) Default(_ context.Context, obj runtime.Object) error {
	cronjob, ok := obj.(*webappv1.CronJob)
...
func (d *CronJobCustomDefaulter) applyDefaults(cronJob *webappv1.CronJob) {
...
// +kubebuilder:webhook:path=/validate-webapp-xilia-net-v1-cronjob,mutating=false,failurePolicy=fail,sideEffects=None,groups=webapp.xilia.net,resources=cronjobs,verbs=create;update,versions=v1,name=vcronjob-v1.kb.io,admissionReviewVersions=v1
...
func (v *CronJobCustomValidator) ValidateUpdate(_ context.Context, oldObj, newObj runtime.Object) (admission.Warnings, error) {
	cronjob, ok := newObj.(*webappv1.CronJob)
	if !ok {
...
func validateCronJob(cronjob *webappv1.CronJob) error {
	...
	return apierrors.NewInvalid(
		schema.GroupKind{Group: "webapp.xilia.net", Kind: "CronJob"},
		cronjob.Name, allErrs)
}

func validateCronJobSpec(cronjob *webappv1.CronJob) *field.Error {
...
func validateCronJobName(cronjob *webappv1.CronJob) *field.Error {
